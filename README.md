...
```
* (THE FOLLOWING STEPS ARE OPTIONAL) Create the following directories within the cloned repository to set up input files (the sample_data directory and contents should already be present after cloning the repo).
```
mkdir -p data
```
